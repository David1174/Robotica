...
def actualizar_hora():
    ...
    if hora_actual == entrada_hora1.get() and not mensaje_mostrado_hora1:
        
        print("horaior 1 bien")

    # Verifica si la hora actual coincide con el segundo horario ingresado y si no se ha mostrado el mensaje
    elif hora_actual == entrada_hora2.get() and not mensaje_mostrado_hora2:
        
        print("horario 2 bien")
